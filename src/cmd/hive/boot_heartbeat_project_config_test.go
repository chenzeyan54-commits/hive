...
// These tests drive the hub.ProjectConfigCallback that bootHeartbeatWith
...
func projectConfigCallback(t *testing.T, f *bootHeartbeatFake) hub.ProjectConfigCallback {
	t.Helper()
	return heartbeatCallback[hub.ProjectConfigCallback](t, f)
}
...
func TestBootHeartbeatProjectConfig_URLOnlyPushAdoptsVanityURLWithoutTouchingProject(t *testing.T) {
	...
	projectConfigCallback(t, f)(&hub.HeartbeatProjectConfig{
